...
Follow the [source installation guide](installation.md#guided-source-install) for the current platform. On Fedora, you can instead reinstall the COPR package:
